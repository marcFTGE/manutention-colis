        ...
        <div class="card bg-secondary shadow">
          <div class="card-header bg-white border-0">
            <div class="row align-items-center">
              <div class="col-8">
                <h3 class="mb-0">Créer les comptes clients</h3>
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" id="input-last-name2" required name="phone" class="form-control form-control-alternative" placeholder="Téléphone">
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
