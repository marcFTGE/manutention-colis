...
<div class="row">
    <div class="col-xl-4">
      ...
      <ul class="list-unstyled">
        <li class="text-muted">De: <span style="color:#5d9fc5 ;">  {{ $details['colis11'] }}  {{ $details['colis22'] }} </span></li>
...
<div class="row">
  <div class="col-xl-4">
      <p class="text-muted"> <span style="color:#5d9fc5; font-weight: bold;">Veillez vous connecter à votre compte Logistics via ces informations</span></p>
    <ul class="list-unstyled">
      <li class="text-muted">Login: {{ $details['colis7'] }} </li>
      <li class="text-muted">Mot de passe: {{ $details['colis8'] }}  </li>
    </ul>
  </div>
</div>
<td>
